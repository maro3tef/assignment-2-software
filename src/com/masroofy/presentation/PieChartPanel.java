...
public class PieChartPanel extends JPanel {
    ...
    public void setTotals(Map<String, Double> totals) {
        ...
        repaint(); // Force the panel to redraw whenever data changes
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Define a palette of colors for the pie slices
        Color[] colors = {
        ...
        for (Map.Entry<String, Double> entry : categoryTotals.entrySet()) {
            ...
            // Calculate the angle for this slice (amount / total * 360 degrees)
